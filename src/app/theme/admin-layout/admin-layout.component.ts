import {
    Component, OnInit, OnDestroy, ViewChild, HostBinding, ElementRef, Inject, Optional, ViewEncapsulation
} from '@angular/core';
...
import { AppDirectionality } from '../../core/services/directionality.service';
